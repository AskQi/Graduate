...
if SCP==1           % 表面
    ...
    elseif ParameterData{ind}.type==144 % trimmed surface
        
        srfind=ParameterData{ind}.pts;%被裁减的曲面编号
        ...
        if ParameterData{srfind}.type==128
            ...
            if ParameterData{ind}.trimmed %裁剪曲面被曲线裁开
                
                n2=ParameterData{ind}.n2;%内边界个数
                NN=ones(1,n2+1);
                ...
                if ParameterData{ind}.n1%外边界不是D（定义域）的边界
        ...
        elseif ParameterData{srfind}.type==108%被裁曲面为平面实体
    ...
    elseif ParameterData{ind}.type==143%有界曲面实体
